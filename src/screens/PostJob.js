...
console.log("users==>",users)
 ...
 const reference=database().ref('/Admin').child('company').child('Jobs').push(users)
...
<ScrollView >
 ...
 <View style={{flexDirection:'row'}}>
   ...
   <View  style={{flex:2,alignSelf:'center'}}><Text style={{fontSize:40,justifyContent:'center'}}>Post Job</Text></View>
...
<View style={{borderWidth:1,borderColor:'grey',marginVertical:10}}>
      ...
      <TextInput onChangeText={(text)=>this.setState({companyName:text})}  placeholder="Company Name"  style={styles.EmailAddress}/>
      </View>
      <View style={{justifyContent:"center",alignItems:"center",marginTop:10}}>
...
<TextInput  onChangeText={(text)=>this.setState({position:text})} placeholder="Add Post for which position"  style={styles.Qualification}/>
</View>
<View style={{justifyContent:"center",alignItems:"center"}}>

<TextInput  onChangeText={(text)=>this.setState({Qualification:text})} placeholder="Minimum Qualification Required"  style={styles.Qualification}/>
</View>
<View style={{justifyContent:"center",alignItems:"center"}}>

<TextInput  onChangeText={(text)=>this.setState({field:text})} placeholder="Field Required"  style={styles.Qualification}/>
</View>
