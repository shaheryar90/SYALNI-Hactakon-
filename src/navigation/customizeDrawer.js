        ...
        <ImageBackground
          ...
          <TouchableOpacity
            ...
            <View style={{flexDirection: 'row', marginVertical: 20}}>
              <View style={{flex: 1, marginLeft: 10}}>
                <Icon style={styles.icon} name="home" size={25} color="black" />
              </View>
              <View style={{flex: 3}}>
          ...
          <TouchableOpacity
            ...
            <View style={{flexDirection: 'row', marginVertical: 20}}>
              ...
              <View style={{flex: 3}}>
                <Text style={{color: 'black', fontSize: 20}}>Post a job</Text>
              </View>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <View style={{flexDirection: 'row', marginVertical: 20}}>
              ...
              <View style={{flex: 3}}>
                <Text style={{color: 'black', fontSize: 20}}>Job Detail</Text>
              </View>
            </View>
          </TouchableOpacity>
