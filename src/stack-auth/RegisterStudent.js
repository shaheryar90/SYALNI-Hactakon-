...
import { Button, View,TextInput,Dimensions ,StyleSheet, TouchableOpacity,Text,Image,ScrollView,ImageBackground} from 'react-native';
...
console.log("users==>",users)
 ...
 const reference=database().ref('/Admin').child('student').push(users)
...
<ScrollView >
 ...
 <Text style={{justifyContent:"center",alignSelf:'center'}}>As A Student</Text>
...
<TextInput placeholder="Higher Qualification"  style={styles.Qualification}/>
</View>
<View style={{justifyContent:"center",alignItems:"center"}}>

<TextInput placeholder="Applied for the position"  style={styles.Qualification}/>
</View>
